package com.mignardi.movie_streaming_service.controller;

import com.mignardi.movie_streaming_service.service.MovieCatalogService;
...
public class MovieStreamController {
    ...
    public final static String DIRECTORY = "C:\\Users\\migna\\Downloads\\LearnMicroservices\\";
    ...
    public ResponseEntity<InputStreamResource> streamVideoById(@PathVariable Long videoInfoId) throws FileNotFoundException {
        ...
        LOGGER.log(Level.INFO, "Resolved movie path = {0}", moviePath);
